                    ...
                    Center(
                      ...
                      child: InkWell(
                        onTap: () {
                          ...
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>mesajSayfa(kullanici: widget.kuladi,adim: _auth.currentUser.displayName, karsiUid: widget.uid,uid: _auth.currentUser.uid,dc:_auth.currentUser.uid+widget.uid,
                            pp: widget.pp,karsiPp:_auth.currentUser.photoURL,)));
