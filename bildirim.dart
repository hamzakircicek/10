        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot){
          ...
          return ListView(
            ...
            children:[ Column(
              ...
              docc=doc['karsiUid']+doc['uid'];
              doccters=doc['uid']+doc['karsiUid'];
                  ...
                  Text(doc['onayDurumu']==false  ? doc['kullanici']+' senin kiralama isteğini reddetti' : doc['kullanici']+' senin kiralama isteğini kabul etti',
                    ...
                    IconButton(icon: doc['onayDurumu']==true ? Icon(Icons.message_outlined,size: 25, color: Colors.white,) : Icon(Icons.cloud_off,size: 25, color: Colors.white,),
                        ...
                        if(doc['onayDurumu']==true ){
                          ...
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>mesajSayfa(kullanici: doc['kullanici'],adim: doc['adim'], karsiUid: doc['uid'],uid: doc['karsiUid'],
                            dc:_auth.currentUser.uid==doc['uid'] ||_auth.currentUser.uid==doc['karsiUid'] ?docc:doccters,
