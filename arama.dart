...
void initState() {
          ...
          return Scaffold(
            ...
            StreamBuilder(
              ...
              builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                 ...
                 url=doc['resim'];
                 idd=doc.id;
                      aranmalar(_auth.currentUser.displayName,doc['kullanici'],doc['pp'],doc['resim'],doc['email'],doc['ad'],doc['aciklama'],doc['lokasyon'],doc['fiyat'],txt.text,doc['uid'],url,idd );}).toList();
  ...
  void aranmalar(myname,kullanici,pp,res,email,ad,aciklama,lokasyon,fiyat,String a,String u,var r,String dc)async{
  try{
  Map <String, dynamic> arama=Map();
  arama['myname']=myname;
  arama['kullanici']=kullanici;
  arama['pp']=pp;
  arama['resim']=res;
  arama['email']=email;
  arama['ad']=ad;
  arama['aciklama']=aciklama;
  arama['lokasyon']=lokasyon;
  arama['fiyat']=fiyat;
  arama['arama']=a;
  arama['uid']=u;
  arama['resim']=r;
