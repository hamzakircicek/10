...
class _profilState extends State<profil> {
        ...
        children: [
          Column(
              children: [ Padding(
                ...
                SizedBox(height: 25,),
                Text("Göderdiğin Kiralama İstekleri",style: GoogleFonts.comfortaa(fontSize: 20)),
                SizedBox(height: 10,),
                StreamBuilder(
  ...
  void galeriden(String foto) async {
    try {
      ...
      _firestore.collection('kullanicilar').doc(_auth.currentUser.displayName).update({"pp":url});
      progressDialog.hide();
    } catch (e) {
