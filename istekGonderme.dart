      ...
      body:ListView(
          children:[ Container(
            ...
            Container(
              ...
              height:25,
              child: Center(child: Text(sayac==1?widget.fiyat:fiyatt.toString(), style: GoogleFonts.comfortaa(fontWeight: FontWeight.bold,fontSize: 15,color: Colors.blueGrey, decoration: TextDecoration.none,),)) ,
            ),
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child:  Center(
                      child: Text(
                          sayac.toString(),style: TextStyle(fontSize: 20),
                      ),
                    ),
            ...
            Row(
              ...
              children: [
                ...
                InkWell(
                  onTap: (){
                    siparis(widget.karsiPp,widget.ad,sayac.toString(),widget.kullanici,_auth.currentUser.uid, _auth.currentUser.email, _auth.currentUser.photoURL, _auth.currentUser.displayName, widget.url ,widget.aciklama, widget.lokasyon,
                        sayac==1?widget.fiyat:fiyatt.toString(),widget.uid,
